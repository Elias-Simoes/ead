...
- [x] 1. Criar migração de banco de dados para suporte a PIX e parcelamento
...
- [ ] 2. Implementar serviço de configuração de pagamentos
  ...
  - [x] 2.1 Criar PaymentConfigService com métodos getConfig() e updateConfig()
  ...
  - [x] 2.2 Escrever testes de propriedade para configurações


    - **Property 7: Configurações afetam novos checkouts**
    - **Validates: Requirements 7.4**
  
  - [x] 2.3 Criar endpoint GET /api/payments/config
  ...
  - [x] 2.4 Criar endpoint PUT /api/admin/payments/config (admin only)
...
- [x] 3. Expandir StripeService para suportar PIX e parcelamento





  - [x] 3.1 Adicionar método createCheckoutWithPaymentOptions()
  ...
  - [x] 3.2 Escrever testes de propriedade para parcelamento


    - **Property 2: Parcelamento calcula valores corretos**
    - **Validates: Requirements 2.2, 2.5**
  
  - [x] 3.3 Escrever testes de propriedade para limite de parcelas


    - **Property 8: Parcelamento respeita limite configurado**
    - **Validates: Requirements 2.1, 7.1**
  
  - [x] 3.4 Adicionar método getPaymentIntentDetails()

    - Buscar detalhes do PaymentIntent
    - Extrair informações de parcelamento
    - _Requirements: 2.4_

- [x] 4. Implementar PixPaymentService





  - [x] 4.1 Criar PixPaymentService com método createPixPayment()
  ...
  - [x] 4.2 Escrever testes de propriedade para desconto PIX


    - **Property 1: Desconto PIX é aplicado corretamente**
    - **Validates: Requirements 3.1, 4.1, 4.3**
  
  - [x] 4.3 Escrever testes de propriedade para unicidade de QR Code

    - **Property 6: QR Code é único por pagamento**
    - **Validates: Requirements 3.2, 3.3**
  
  - [x] 4.4 Criar método checkPixPaymentStatus()
  ...
  - [x] 4.5 Escrever testes de propriedade para polling

    - **Property 5: Polling detecta confirmação de pagamento**
    - **Validates: Requirements 6.1, 6.2**
  
  - [x] 4.6 Criar job de expiração de pagamentos PIX
  ...
  - [x] 4.7 Escrever testes de propriedade para expiração

    - **Property 3: Pagamento PIX expira após tempo configurado**
    - **Validates: Requirements 5.1, 5.2**

- [x] 5. Atualizar PaymentController e rotas





  - [x] 5.1 Atualizar POST /api/payments/checkout
  ...
  - [x] 5.2 Criar GET /api/payments/pix/:paymentId/status
  ...
  - [x] 5.3 Atualizar webhook handler para processar PIX
  ...
  - [x] 5.4 Escrever testes de propriedade para webhook PIX


    - **Property 4: Webhook PIX ativa assinatura**
    - **Validates: Requirements 5.3, 5.4, 5.5**

- [x] 6. Checkpoint - Garantir que backend está funcionando
...
- [x] 7. Criar componente PaymentMethodSelector (Frontend)





  - [x] 7.1 Implementar UI de seleção entre Cartão e PIX
  ...
  - [x] 7.2 Criar componente PaymentComparison
...
- [x] 8. Criar componente CardPaymentForm (Frontend)





  - [x] 8.1 Implementar seletor de parcelas
  ...
  - [x] 8.2 Implementar botão de confirmação
...
- [x] 9. Criar componente PixPaymentForm (Frontend)
  ...
  - [x] 9.1 Implementar exibição de valor com desconto
  ...
  - [x] 9.2 Implementar geração e exibição de QR Code
  ...
  - [x] 9.3 Implementar timer de expiração
  ...
  - [x] 9.4 Implementar polling de status
  ...
  - [x] 9.5 Implementar UI responsiva para mobile
...
- [x] 10. Criar nova CheckoutPage (Frontend)





  - [x] 10.1 Implementar layout principal
  ...
  - [x] 10.2 Integrar componentes de pagamento
  ...
  - [x] 10.3 Implementar busca de configurações
...
- [x] 11. Atualizar SubscriptionRenewPage





  - [x] 11.1 Redirecionar para nova CheckoutPage
...
- [x] 12. Criar página de administração de configurações de pagamento
  ...
  - [x] 12.1 Implementar PaymentConfigPage (admin)
...
- [x] 13. Implementar notificações por email
  ...
  - [x] 13.1 Email de pagamento PIX pendente
  ...
  - [x] 13.2 Email de pagamento PIX confirmado
  ...
  - [x] 13.3 Email de pagamento PIX expirado
...
- [x] 14. Adicionar logging e monitoramento





  - [x] 14.1 Implementar logs estruturados
  ...
  - [x] 14.2 Criar dashboard de métricas
...
- [x] 15. Testes de integração e E2E





  - [x] 15.1 Testes de integração backend
  ...
  - [x] 15.2 Testes E2E com Playwright
